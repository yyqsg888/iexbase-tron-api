...
class Tron implements TronInterface
{
    ...
    /**
     * Query information about an account via solidity api
     *
     * @param $address
     * @return array
     * @throws TronException
    ...
    /**
     * Query information about an account via trongrid API
     * Gets only confirmed TXs and balances by default
     *
     * @param $address
     * @return array
     * @throws TronException
     */
    public function getAccountApi(string $address = null): array
    {
        $address = (!is_null($address) ? $this->toHex($address) : $this->address['hex']);
